...
<<<<<<< HEAD
   ...
   {/*Used hooks like USe Effect To slide the image every 4 seconds
    helps to slide every 4 seconds 
    4000 mil = 4 sec */ }
    useEffect(() => {
...
>>>>>>> main
  ...
  return (
    <section className="relative w-full h-[100vh] overflow-hidden">
      ...
      {/* Overlay Content — Passing the declared Type text variable here */}
      ...
      {/* Manual Buttons — Added this to allow manual slide control */}
