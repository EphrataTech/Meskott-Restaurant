...
>
  <div className="flex items-center gap-1 cursor-pointer text-[#C99A56] hover:text-white">
    <span>Menu</span>
  ...
  {isMenuOpen && (
    <div className="absolute top-full left-0 mt-2 bg-white dark:bg-gray-800 text-black dark:text-white shadow-lg rounded-md p-2 min-w-[150px] z-50 transition-all duration-300">
      <a href="#starters" className="block px-3 py-1 hover:text-black text-[#C99A56]">
        Starters
      </a>
      <a href="#main-course" className="block px-3 py-1 hover:text-black text-[#C99A56]">
        Main Course
      </a>
      <a href="#desserts" className="block px-3 py-1 hover:text-black text-[#C99A56]">
        Desserts
      </a>
